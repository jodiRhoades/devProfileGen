         ...
         <div class="wrapper">
          <div class="photo-header">
            <img src="${data.avatar_url}" alt="coder photo" height="75">
              ...
              <nav class="links-nav">            
                <a href="https://www.google.com/maps/place/${data.location}" class="nav-link" target="_blank"><i class="fas fa-location-arrow"></i> Charlotte, NC</a>
                        
                <a href="${data.blog}" class="nav-link" target="_blank"><i class="fas fa-rss"></i> Blog</a>
